...
# Skills
[![My Skills](https://skillicons.dev/icons?i=python,flask,java,spring,idea,go,linux,docker,bash,php,html,js,cpp,c,git,md,mysql,redis,arduino,vs code,vs,ps,gmail)](https://skillicons.dev)
